...
// A "v2" key (RFC 5958 OneAsymmetricKey) that includes the public key in
// addition to the private key. The public key is an implicitly tagged BIT
// STRING (a primitive `[1]` context tag), per RFC 8410 section 10.3.
pub const ED25519_TEST_KEY_PAIR_PEM_V2: &str = r#"
-----BEGIN PRIVATE KEY-----
MFECAQEwBQYDK2VwBCIEIC2pHJYjFHhK8V7mj6BnHWUVMS4CRolUlDdRXKCtguDu
gSEA67x/8fDcfbp7bLnOhE/nHt8Oz0ri2PAS1nB3Vwxr5EA=
-----END PRIVATE KEY-----
"#;
