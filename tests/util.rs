...
// TODO generating with `openssl genpkey -algorithm ED25519` doesn't work.
// How can one use openssl to generate the key?
// https://github.com/briansmith/ring/issues/833
pub const ED25519_TEST_KEY_PAIR_PEM :&str = r#"
-----BEGIN PRIVATE KEY-----
